...
<figure data-type="image" small>
  <div stack column>
    <img src="../assets/2018-type-vue/1.png" alt="Screenshot: Intellisense/Type-based suggestion" />
    <img src="../assets/2018-type-vue/2.png" alt="Screenshot: Type mismatch error" />
  </div>
...
<figure data-type="image" large>
  <div stack row wide>
    <img src="../assets/2018-type-vue/3.png" alt="VS Code type inference in Vue components written in JavaScript">
    <img src="../assets/2018-type-vue/4.png" alt="VS Code type inference in Vue components written in TypeScript">
  </div>
...
<figure data-type="image" large>
  <div stack column>
    <img src="../assets/2018-type-vue/6.png" alt="VS Code type inference on object properties">
    <img src="../assets/2018-type-vue/7.png" alt="return value from function">
  </div>
...
<figure data-type="image">
  <div stack row wide>
    <img src="../assets/2018-type-vue/14.png" alt="Vue component definition">
    <img src="../assets/2018-type-vue/15.png" alt="Inferred type data object">
  </div>
...
<figure data-type="image">
  <div stack row wide>
    <img src="../assets/2018-type-vue/16.png" alt="Vue component definition">
    <img src="../assets/2018-type-vue/17.png" alt="inferred type data object">
  </div>
...
<figure data-type="image">
  <div stack row>
    <img src="../assets/2018-type-vue/18.png" alt="JSDoc typedef example">
    <img src="../assets/2018-type-vue/19.png" alt="inferred type in VS Code">
  </div>
