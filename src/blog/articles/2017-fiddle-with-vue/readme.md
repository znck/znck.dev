...
<figure data-type="code">
  <div data-iframe>
    <iframe width="100%" height="480" src="//jsfiddle.net/znck/hm2sfh4r/embedded/js,html,css,result/dark/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
  </div>

  <figcaption>An example fiddle</figcaption>
</figure>
